...
final readonly class Header implements _\ComponentInterface
{
    ...
    public static function create(
        _\ComponentInterface|string $logo,
        string $homeUri,
        _\ComponentInterface|string $menuItems,
    ): self {
        return new self(
